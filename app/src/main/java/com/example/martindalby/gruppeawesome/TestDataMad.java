...
public class TestDataMad {
    ...
    public TestDataMad(){
        ...
        aftensmad = new TestDataMad[]{
                new TestDataMad("Kylling", "Denne ret smager godt","1 stk. ost \n2 æg \n100g kylling \n\n200g prot" ,R.drawable.pizzalistepic),
                ...
                new TestDataMad("Salat", "Ok det er salat... med kød istedet for salat #Prot","1 stk. ost \n2 æg \n100g kød \n\n200g prot" , R.drawable.pizzalistepic)
        };
        frokost = new TestDataMad[]{
                ...
                new TestDataMad("God mad", "Det her er rigtig god mad, til dig der kan lide mad!","1 stk. ost \n2 æg \n100g kød \n\n200g prot" , R.drawable.pizzalistepic)
        };
        morgenmad = new TestDataMad[]{
                new TestDataMad("God gryde", "God skål gryn med masser af prot! og ost","1 stk. ost \n2 æg \n100g kød \n\n200g prot" , R.drawable.morgenmad),
        ...
        snack = new TestDataMad[] {
                new TestDataMad("Peanutbutter", "Der er masser af prot i","1 stk. ost \n2 æg \n100g kød \n\n200g prot" , R.drawable.morgenmad),
